...
% Entities
\node[entity] (produit) {Produit\\ \scriptsize \textbf{idProduit} (AUTO\_INC), nomProduit, marque, quantite, quantiteMinimale, prix, TVA, type};
...
ALTER TABLE Produit 
ADD COLUMN quantiteMinimale INT DEFAULT 10 NOT NULL;
\end{lstlisting}
